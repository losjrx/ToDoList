...
public class App {
	...
	public static void main(String[] args) {
		...
		while (menu != 7) {
			...
			if (menu == 1) {
				...
				ordenarPorCategoria(listaDeTarefas);
			} else if (menu == 4) {
				ordenarPorStatus(listaDeTarefas);
			} else if (menu == 5) {
	...
	public static void ordenarPorCategoria(ArrayList<Tarefa> listaDeTarefas) {
		
		Collections.sort(listaDeTarefas, new OrdenarPorCategoria());  
		verListaDeTarefas(listaDeTarefas);
	}
	
	public static void ordenarPorStatus(ArrayList<Tarefa> listaDeTarefas) {
		Collections.sort(listaDeTarefas, new OrdenarPorStatus());  
		verListaDeTarefas(listaDeTarefas);
	}
